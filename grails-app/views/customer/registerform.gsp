...
body {
	...
	<ul>
		<form name="myform" method="POST" action="/customer_manager/customers"
			...
			<fieldset>
				<div>
					<input type="text" name="customer_first_name"
						placeholder="First Name" ng-model="user.customer_first_name"
						ng-required="true">
					<p class="error validationerror"
						ng-show="myform.customer_first_name.$invalid && myform.customer_first_name.$touched">
						You must fill out your first name.</p>
				</div>
				<div>
					<input type="text" name="customer_last_name"
						placeholder="Last Name" ng-model="user.customer_last_name"
						ng-required="true">
					<p class="error validationerror"
						ng-show="myform.customer_last_name.$invalid && myform.customer_last_name.$touched">
				...
				<div>
					...
					<p>{{user.email}}</p>
					<p class="error validationerror"
						ng-show="myform.email_address.$invalid && myform.email_address.$touched">
				</div>
				<div>
					<input type="text" name="address" placeholder="Address"
						ng-model="user.address" ng-required="true">
					<p class="error validationerror"
						ng-show="myform.address.$invalid && myform.address.$touched">
				...
				<div>
					<input type="text" name="school_name" placeholder="School Name"
						ng-model="user.schoo_lname" ng-required="false">
				</div>
			</fieldset>

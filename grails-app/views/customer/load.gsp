...
<body>
	<g:form name="edit_form" controller="customer">
		...
		<div>
			...
			<g:textField name="customer_last_name"
				value="${aCustomer.customer_last_name}" required="false"
				disabled="disabled" />
			<br />
		</div>
		<div>
			<label for="firstName">First Name</label>
			<g:textField name="customer_first_name"
				value="${aCustomer.customer_first_name}" required="false"
				disabled="disabled" />
			<br />
		</div>
		<div>
			<label for="customer_id">ID</label>
			<g:textField name="customer_id" value="${aCustomer.customer_id}"
		...
		<g:textField name="address" value="${aCustomer.address}"
			required="true" />
		<br />

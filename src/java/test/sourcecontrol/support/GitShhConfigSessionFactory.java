...
/* larry.li01@sap.com
 * 2017-02
 * JschConfigSessionFactory is used to create a SSH session. 
 * By overriding exiting methods we can create a SSH session for Jgit 
 * This is part of Jgit integration  
 * 
 * 
 * 
 */
